...
1. Explain how you got the HTML, with the correct data, displayed in the browser?
   ...
   > In main.js I defined a function named ‘renderPotteryToDOM’ and passed in a parameter named ‘potteryHTML’ which is my generated string of HTML content. Next, I had to go into the index.html and I noticed that there was no assigned elementID. Inside of the <body> I made a <main> and nested a <section> inside of it and gave it an element id of ‘potteryList’. After I did that I went back to my main.js and used document.getElementById(“potteryList”) and stored it in the variable potteryListElement. Next, I used an if/else statement to check if the element is ‘null’. If the element exists and it executes the line of code inside the ‘if’ block then the next line of code sets the ‘innerHTML’ property of the ‘potteryListElement’ to the ‘potteryHTML’  effectively replacing the content of the selected HTML element with the new HTML string. Alternatively, if the element does not exist, it will console an error message. Finishing up is called the ‘potteryList’ function, which generates the HTML content for the pottery items, and stores the returned HTML string in the ‘potteryHTML’ variable. Lastly, I invoked the ‘renderPotteryToDOM’ function passing in ‘potteryHTML’ as an argument so that it updates the DOM with the stored HTML
   content in ‘potteryHTML’.

2. In the **PotteryList** module, when you iterate your pottery, you need to show the evidence of what the **weight** property's value is for the 2nd piece of pottery. Use [Loom](https://www.loom.com/) to record your browser window with the developer tools open and show those values.

   > (https://www.loom.com/share/04139217cc3540cf829376de1bf3819f)

3. The **PotteryWheel** module has a single function named `makePottery`. Why doesn't that module have all of the other code in it?

   > The idea behind this module seems to be to house all of the pottery objects with a unique ID. Making like a database module where you can clearly access your object at any point you may need to reference it.

4. The pottery shop has learned that there is a set of customers that are willing to buy cracked pottery at a discounted price of $2.50. That means that the cracked pottery should now be displayed in the catalog. Explain the changes that this new business strategy would cause to your algorithm.

   >  I would go in to my toSellOrNotToSell function and change it a bit to not only check things that are cracked and would instead do an if/else statement where if (pottery.cracked){ pottery.price = 2.50 } and then the rest of my code would remain the same.

5. In the **Kiln** module, you have a `firePottery()` function. You need to demonstrate how to use the debugger to verify the values of the parameters for that function when your code runs. Use [Loom](https://www.loom.com/) to record your browser window with the developer tools open and show those values.
   
   > (https://www.loom.com/share/59abfafd53b140afbf4cf6174e301852)
